...
public class Atributos_MT {
    ...
    // protectec solo esta permitido a el paquete
    // o la clase que se herede 

    protected int numeros_logicos;
    protected String numeros_neperianos;
    protected Float numers_imaginarios;
